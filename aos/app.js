...
function main() {
  ...
  program
    ...
    .option('-d, --daemon', 'Run aos node as daemon')
  ...
  var pidFile = path.join(baseDir, 'aos.pid');
  if (fs.existsSync(pidFile)) {
    console.log('Failed: aos server already started');
    return;
  }
  ...
  if (program.daemon) {
    console.log('aos server started as daemon ...');
