 ...
 */
angular.module('aos').controller('assigneeCtrl', function ($scope, $rootScope, apiService, ipCookie, $location, $http, userService, postSerivice, $translate) {
    ...
    $scope.createTransaction = function () {
        return aosJS.delegate.createDelegate($scope.userName, userService.secret, $scope.secondpassword)
    }
