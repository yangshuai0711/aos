angular.module('aos').controller('votetoCtrl', function ($scope, $rootScope, apiService, ipCookie, $location, $http, userService, postSerivice, $translate) {
    ...
    $scope.createTransaction = function() {
        return aosJS.vote.createVote($rootScope.voteContent, userService.secret, $scope.secondpassword);
    }
