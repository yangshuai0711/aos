angular.module('aos').controller('deletevoteCtrl', function ($scope, $rootScope, apiService, ipCookie, $location, $http, userService, postSerivice, $translate) {
    ...
    $scope.createTransaction = function () {
        return aosJS.vote.createVote($rootScope.deletevoteContent, userService.secret, $scope.secondpassword)
    }
