angular.module('aos').controller('applicationCtrl', function ($scope, $rootScope, apiService, ipCookie, $location, $window, NgTableParams, userService, $translate, postSerivice) {
  ...
  $scope.createTransaction = function () {
    if ($scope.currency.value == 'XAS') {
      ...
      return aosJS.transfer.createInTransfer($scope.depositedDapp.transactionId, $scope.currency.value, amount, userService.secret, $scope.secondPassword);
    } else {
